...
const std::map<ActionToolID, ActionCatalogItem> action_catalog = {
        ...
        {ActionID::EXPORT_SOLID_MODEL_STL, {"Export STL", ActionGroup::DOCUMENT, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::EXPORT_SOLID_MODEL_STEP, {"Export STEP", ActionGroup::DOCUMENT, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::EXPORT_ALL_SOLID_MODELS_STEP,
         {"Export STEP (all)", ActionGroup::DOCUMENT, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ToolID::DRAW_LINE_3D, {"Draw line in 3D", ActionGroup::DRAW, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ToolID::DRAW_WORKPLANE, {"Draw workplane", ActionGroup::DRAW, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ToolID::SET_WORKPLANE, {"Set active workplane", ActionGroup::UNKNOWN, ActionCatalogItem::FLAGS_HIDDEN}},
        {ToolID::UNSET_WORKPLANE, {"Unset active workplane", ActionGroup::UNKNOWN, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ToolID::CONSTRAIN_WORKPLANE_NORMAL,
         {"Constrain workplane normal", ActionGroup::CONSTRAIN, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ToolID::CONSTRAIN_POINT_IN_PLANE,
         {"Constrain point in plane", ActionGroup::CONSTRAIN, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ToolID::ADD_ANCHOR, {{"Add STEP anchor", "Add anchor"}, ActionGroup::DRAW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ToolID::ADD_CLUSTER_ANCHOR,
         {{"Add Cluster anchor", "Add anchor"}, ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::MOVE_ANCHOR,
         {{"Move STEP anchor", "Move anchor"}, ActionGroup::DRAW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ToolID::ENTER_DATUM, {"Enter datum", ActionGroup::UNKNOWN, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::IMPORT_STEP, {"Import STEP", ActionGroup::UNKNOWN, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ToolID::SELECT_EDGES, {"Select edges", ActionGroup::UNKNOWN, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ActionID::TOGGLE_SOLID_MODEL, {"Toggle solid model", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::VIEW_ALL, {"Reset view", ActionGroup::VIEW, ActionCatalogItem::FLAGS_IN_TOOL}},
        {ActionID::VIEW_ROTATE_UP, {"Rotate up 90°", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::VIEW_ROTATE_DOWN, {"Rotate down 90°", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::VIEW_ROTATE_LEFT, {"Rotate left 90°", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::VIEW_ROTATE_RIGHT, {"Rotate right 90°", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::VIEW_TILT_LEFT, {"Tilt left 90°", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::VIEW_TILT_RIGHT, {"Tilt right 90°", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ActionID::VIEW_PERSP, {"View perspective", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::VIEW_ORTHO, {"View orthographic", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::VIEW_TOGGLE_PERSP_ORTHO, {"Toggle persp/ortho", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ActionID::CREATE_GROUP_EXTRUDE,
         {"Create extrude group", ActionGroup::GROUP, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::CREATE_GROUP_LATHE, {"Create lathe group", ActionGroup::GROUP, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::CREATE_GROUP_REVOLVE,
         {"Create revolve group", ActionGroup::GROUP, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::CREATE_GROUP_FILLET, {"Create fillet group", ActionGroup::GROUP, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::CREATE_GROUP_CHAMFER,
         {"Create chamfer group", ActionGroup::GROUP, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::CREATE_GROUP_LINEAR_ARRAY,
         {"Create linear array group", ActionGroup::GROUP, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::CREATE_GROUP_POLAR_ARRAY,
         {"Create polar array group", ActionGroup::GROUP, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::CREATE_GROUP_MIRROR_HORIZONTAL,
         {"Create mirror horizontally group", ActionGroup::GROUP, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::CREATE_GROUP_MIRROR_VERTICAL,
         {"Create mirror vertically group", ActionGroup::GROUP, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ActionID::CREATE_GROUP_SOLID_MODEL_OPERATION,
         {"Create solid model operation group", ActionGroup::GROUP, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::CREATE_GROUP_CLONE, {"Create clone group", ActionGroup::GROUP, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::CREATE_GROUP_PIPE, {"Create pipe group", ActionGroup::GROUP, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::MOVE_GROUP_UP, {"Move current group up", ActionGroup::GROUP, ActionCatalogItem::FLAGS_DEFAULT}},
        ...
        {ActionID::MOVE_GROUP_TO_END_OF_BODY,
         {"Move current group to end of body/next body", ActionGroup::GROUP, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ActionID::TOGGLE_WORKPLANE, {"Toggle workplane", ActionGroup::UNKNOWN, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::ALIGN_VIEW_TO_WORKPLANE,
         {"Align view to workplane", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::ALIGN_VIEW_TO_CURRENT_WORKPLANE,
         {"Align view to current workplane", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::CENTER_VIEW_TO_WORKPLANE,
         {"Center view to workplane", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::CENTER_VIEW_TO_CURRENT_WORKPLANE,
         {"Center view to current workplane", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::ALIGN_AND_CENTER_VIEW_TO_WORKPLANE,
         {"Align&center view to workplane", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::VIEW_RESET_TILT, {"Reset tilt", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::VIEW_FRONT, {"View front", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::VIEW_BACK, {"View back", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::VIEW_TOP, {"View top", ActionGroup::VIEW, ActionCatalogItem::FLAGS_IN_TOOL}},
        {ActionID::VIEW_BOTTOM, {"View bottom", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::VIEW_LEFT, {"View left", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::VIEW_RIGHT, {"View right", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ActionID::EXPORT_PROJECTION, {"Export projection", ActionGroup::DOCUMENT, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::EXPORT_PROJECTION_ALL,
         {"Export projection of all groups", ActionGroup::DOCUMENT, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::CLIPPING_PLANE_WINDOW, {"Clipping planes", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        {ActionID::TOGGLE_CLIPPING_PLANES,
         {"Toggle clipping planes", ActionGroup::VIEW, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ActionID::EXPLODE_CLUSTER, {"Convert to geometry", ActionGroup::UNKNOWN, ActionCatalogItem::FLAGS_SPECIFIC}},
        ...
        {ToolID::CONSTRAIN_POINT_PLANE_DISTANCE,
         {"Constrain point/plane distance", ActionGroup::CONSTRAIN, ActionCatalogItem::FLAGS_HIDDEN}},
        {ToolID::MEASURE_POINT_PLANE_DISTANCE,
         {"Measure point/plane distance", ActionGroup::MEASURE, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ToolID::SELECT_SPINE_ENTITIES,
         {"Select spine entities", ActionGroup::UNKNOWN, ActionCatalogItem::FLAGS_HIDDEN}},
        ...
        {ToolID::IMPORT_PICTURE_SILENT,
         {"Import Picture (silent)", ActionGroup::UNKNOWN, ActionCatalogItem::FLAGS_HIDDEN}},
...
const LutEnumStr<ToolID> tool_lut = {
        ...
        TOOL_LUT_ITEM(IMPORT_PICTURE_SILENT),
