...
const std::map<InToolActionID, InToolActionCatalogItem> in_tool_action_catalog = {
        ...
        {InToolActionID::TOGGLE_RECTANGLE_SQUARE,
         {"toggle square mode", ToolID::DRAW_RECTANGLE, InToolActionCatalogItem::FLAGS_DEFAULT}},
        {InToolActionID::TOGGLE_RECTANGLE_ROUNDED,
         {"toggle rounded corners", ToolID::DRAW_RECTANGLE, InToolActionCatalogItem::FLAGS_DEFAULT}},
        {InToolActionID::RECTANGLE_CORNER_RADIUS_INC,
         {"increase corner radius", ToolID::DRAW_RECTANGLE, InToolActionCatalogItem::FLAGS_DEFAULT}},
        {InToolActionID::RECTANGLE_CORNER_RADIUS_DEC,
         {"decrease corner radius", ToolID::DRAW_RECTANGLE, InToolActionCatalogItem::FLAGS_DEFAULT}},
        {InToolActionID::TOGGLE_CIRCLE_OVAL,
         {"toggle oval mode", ToolID::DRAW_CIRCLE_2D, InToolActionCatalogItem::FLAGS_DEFAULT}},
        {InToolActionID::TOGGLE_CIRCLE_SLICE,
         {"toggle slice mode", ToolID::DRAW_CIRCLE_2D, InToolActionCatalogItem::FLAGS_DEFAULT}},
        {InToolActionID::CIRCLE_SPAN_INC,
         {"increase arc angle", ToolID::DRAW_CIRCLE_2D, InToolActionCatalogItem::FLAGS_DEFAULT}},
        {InToolActionID::CIRCLE_SPAN_DEC,
         {"decrease arc angle", ToolID::DRAW_CIRCLE_2D, InToolActionCatalogItem::FLAGS_DEFAULT}},
        {InToolActionID::TOGGLE_TEXT_BOLD,
         {"toggle bold text", ToolID::DRAW_TEXT, InToolActionCatalogItem::FLAGS_DEFAULT}},
        {InToolActionID::TOGGLE_TEXT_ITALIC,
         {"toggle italic text", ToolID::DRAW_TEXT, InToolActionCatalogItem::FLAGS_DEFAULT}},
        {InToolActionID::TOGGLE_POLYGON_ROUNDED,
         {"toggle rounded corners", ToolID::DRAW_REGULAR_POLYGON, InToolActionCatalogItem::FLAGS_DEFAULT}},
        {InToolActionID::POLYGON_CORNER_RADIUS_INC,
         {"increase corner radius", ToolID::DRAW_REGULAR_POLYGON, InToolActionCatalogItem::FLAGS_DEFAULT}},
        {InToolActionID::POLYGON_CORNER_RADIUS_DEC,
         {"decrease corner radius", ToolID::DRAW_REGULAR_POLYGON, InToolActionCatalogItem::FLAGS_DEFAULT}},
...
const LutEnumStr<InToolActionID> in_tool_action_lut = {
        ...
        LUT_ITEM(TOGGLE_RECTANGLE_SQUARE),
        LUT_ITEM(TOGGLE_RECTANGLE_ROUNDED),
        LUT_ITEM(RECTANGLE_CORNER_RADIUS_INC),
        LUT_ITEM(RECTANGLE_CORNER_RADIUS_DEC),
        LUT_ITEM(TOGGLE_CIRCLE_OVAL),
        LUT_ITEM(TOGGLE_CIRCLE_SLICE),
        LUT_ITEM(CIRCLE_SPAN_INC),
        LUT_ITEM(CIRCLE_SPAN_DEC),
        LUT_ITEM(TOGGLE_TEXT_BOLD),
        LUT_ITEM(TOGGLE_TEXT_ITALIC),
        LUT_ITEM(TOGGLE_POLYGON_ROUNDED),
        LUT_ITEM(POLYGON_CORNER_RADIUS_INC),
        LUT_ITEM(POLYGON_CORNER_RADIUS_DEC),
